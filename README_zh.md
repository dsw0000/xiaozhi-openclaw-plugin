...
> **小智 (Xiaozhi) ESP32 集成插件** - 为 OpenClaw 提供与小智服务器的 WebSocket 通信能力
...
这是一个 [OpenClaw](https://github.com/anthropics/openclaw) 插件，用于连接到 [xiaozhi-esp32-server](https://github.com/xiaozhi-esp32-server) 项目。通过这个插件，OpenClaw 网关可以与小智 ESP32 智能硬件设备进行双向通信：
...
| 参数 | 类型 | 必填 | 默认值 | 说明 |
|------|------|------|--------|------|
| `serverUrl` | string | ✅ | - | 小智 WebSocket 服务器 URL |
...
- [OpenClaw](https://github.com/anthropics/openclaw) - 强大的 AI Agent 网关系统
- [xiaozhi-esp32-server](https://github.com/xiaozhi-esp32-server) - ESP32 智能硬件服务器

## 相关项目

- [xiaozhi-openclaw-adapter](https://github.com/dsw0000/xiaozhi-openclaw-adapter) - xiaozhi-esp32-server 的服务端适配器
